...
今後、導入した事業者用メニューとして、アルバイトの提出した時間帯を自動でシフト表に反映し、クリック操作のみでシフトを作成できるようにします。その際、あらゆる勤務条件に合わせて柔軟に条件を変更することができるようにしたり、1日の人員数、人件費、繁忙時間帯、メンバーの累計勤務時間、スキル習得度合いなど、機能をリッチ化していきます。

また、フィードバック機能を実装し、機械学習を導入することによって、機械学習が最適な人員を選別できるような機能も搭載できる可能性があります。
