...
│   ├── middleware/
│   │   └── auth_middleware.py      # @require_auth, @require_role + 組織メンバーシップ強制
│   └── utils/
